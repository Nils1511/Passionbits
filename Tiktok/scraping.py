...
# client = ApifyClient("apify_api_8EdEUWWmCQCqhsQKdamgZM34AhWZ6a0MYCN7")  # ← replace with your real token
...
# 1. Initialize client
API_TOKEN = "apify_api_QOJbNnfXBnTpEuzZhuHGdcneaAQEFz2nyqR7"  # os.getenv("APIFY_TOKEN", "<YOUR_API_TOKEN>")
